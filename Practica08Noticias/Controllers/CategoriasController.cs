...
namespace Practica08Noticias.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriasID,Nombre")] Categorias categorias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriasID,Nombre")] Categorias categorias)
        {
